(function (root, factory) {
  ...
  return function ImageZoom(container, opts) {
    ...
    function setup() {
      if (container.children[0] && container.children[0].nodeName === "IMG") {
        data.smallImage = container.children[0];
      }
      ...
      if (data.smallImage) {
        data.sourceImg.element.style.display = "none";
      }
      return data;
    }
    ...
    var events = {
      ...
      handleMouseEnter: function () {
        if (options.lazyLoad && !data.sourceImg.element.src) {
